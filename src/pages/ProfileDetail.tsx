...
import { ArrowLeft, Upload, FileText, MoreHorizontal, CheckCircle2, AlertCircle } from "lucide-react";
...
type Doc = { id: string; name: string; type: string; size: string; uploaded: string; status: "Indexed" | "Processing" };
...
const ProfileDetail = () => {
  ...
  const [tab, setTab] = useState<"documents" | "analysis">("documents");
        ...
        <>
          ...
          >
            ...
            <p className="text-[12px] text-muted-foreground mt-1">
              PDF, DOCX up to 25 MB. Documents are indexed for regulatory analysis.
            </p>
            <input
              ref={fileRef}
              type="file"
